...
from cloud.cloud.doctype.root_domain.test_root_domain import create_test_root_domain

from cloud.cloud.doctype.ssh_key.test_ssh_key import create_test_ssh_key
...
from cloud.cloud.doctype.virtual_machine_image.virtual_machine_image import (
	VirtualMachineImage,
)
