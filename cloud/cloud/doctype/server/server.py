...
from cloud.runner import Ansible
...
class BaseServer(Document, TagHelpers):
	...
	def get_doc(self, doc):
		...
		from cloud.api.server import usage
	...
	def _increase_swap(self, swap_size=4):
		...
		from cloud.api.server import calculate_swap
	...
	def update_tls_certificate(self):
		from cloud.cloud.doctype.tls_certificate.tls_certificate import (
	...
	def fetch_security_updates(self):
		from cloud.cloud.doctype.security_update.security_update import SecurityUpdate
