...
class SiteAnalytics(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.site_analytics_active.site_analytics_active import (
			SiteAnalyticsActive,
		)
		from cloud.cloud.doctype.site_analytics_app.site_analytics_app import SiteAnalyticsApp
		from cloud.cloud.doctype.site_analytics_doctype.site_analytics_doctype import (
			SiteAnalyticsDocType,
		)
		from cloud.cloud.doctype.site_analytics_login.site_analytics_login import (
			SiteAnalyticsLogin,
		)
		from cloud.cloud.doctype.site_analytics_user.site_analytics_user import (
			SiteAnalyticsUser,
		)
