...
class BenchUpdate(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.bench_site_update.bench_site_update import BenchSiteUpdate
		from cloud.cloud.doctype.bench_update_app.bench_update_app import BenchUpdateApp
