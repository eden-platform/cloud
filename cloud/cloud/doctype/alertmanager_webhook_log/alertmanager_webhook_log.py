...
from cloud.cloud.doctype.incident.incident import INCIDENT_ALERT, INCIDENT_SCOPE
...
class AlertmanagerWebhookLog(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.alertmanager_webhook_log_reaction_job.alertmanager_webhook_log_reaction_job import (
