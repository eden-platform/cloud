...
from cloud.api.github import get_access_token, get_auth_headers
from cloud.overrides import get_permission_query_conditions_for_doctype
from cloud.utils import get_current_team, log_error
...
class AppSource(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.app_source_version.app_source_version import AppSourceVersion
