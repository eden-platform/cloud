...
from cloud.utils import log_error, get_valid_teams_for_user
...
from cloud.exceptions import FrappeioServerNotSet
from frappe.contacts.address_and_contact import load_address_and_contact
from cloud.cloud.doctype.account_request.account_request import AccountRequest
from cloud.utils.billing import (
	get_frappe_io_connection,
	get_stripe,
	process_micro_debit_test_charge,
)
from cloud.utils.telemetry import capture
...
class Team(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.child_team_member.child_team_member import ChildTeamMember
		from cloud.cloud.doctype.communication_email.communication_email import (
			CommunicationEmail,
		)
		from cloud.cloud.doctype.invoice_discount.invoice_discount import InvoiceDiscount
		from cloud.cloud.doctype.team_member.team_member import TeamMember
	...
	def invite_team_member(self, email, new_dashboard=False):
		from cloud.api.account import add_team_member
	...
	def billing_details(self, timezone=None):
		...
		if not billing_details.country and timezone:
			from cloud.utils.country_timezone import get_country_from_timezone
