...
from cloud.cloud.doctype.app.app import new_app as new_app_doc
from cloud.cloud.doctype.app_release_approval_request.app_release_approval_request import (
	AppReleaseApprovalRequest,
)
from cloud.cloud.doctype.marketplace_app.utils import get_rating_percentage_distribution
from cloud.utils import get_last_doc, get_current_team
...
class MarketplaceApp(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.marketplace_app_categories.marketplace_app_categories import (
			MarketplaceAppCategories,
		)
		from cloud.cloud.doctype.marketplace_app_screenshot.marketplace_app_screenshot import (
			MarketplaceAppScreenshot,
		)
		from cloud.cloud.doctype.marketplace_app_version.marketplace_app_version import (
