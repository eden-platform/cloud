...
from cloud.api.billing import get_stripe
...
class Invoice(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.invoice_credit_allocation.invoice_credit_allocation import (
			InvoiceCreditAllocation,
		)
		from cloud.cloud.doctype.invoice_discount.invoice_discount import InvoiceDiscount
		from cloud.cloud.doctype.invoice_item.invoice_item import InvoiceItem
		from cloud.cloud.doctype.invoice_transaction_fee.invoice_transaction_fee import (
