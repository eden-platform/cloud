...
from cloud.cloud.doctype.site.site import Site, process_rename_site_job_update
...
from cloud.cloud.doctype.remote_file.test_remote_file import (
...
if typing.TYPE_CHECKING:
	from cloud.cloud.doctype.bench.bench import Bench
...
class TestSite(unittest.TestCase):
	...
	def test_site_rename_doesnt_update_host_name_for_custom_domain(self):
		...
		from cloud.cloud.doctype.site_domain.test_site_domain import create_test_site_domain
