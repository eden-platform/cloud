...
if TYPE_CHECKING:
	from cloud.cloud.doctype.incident_settings_user.incident_settings_user import (
...
class Incident(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.incident_alerts.incident_alerts import IncidentAlerts
		from cloud.cloud.doctype.incident_updates.incident_updates import IncidentUpdates
