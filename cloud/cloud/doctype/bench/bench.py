...
from cloud.cloud.doctype.bench_shell_log.bench_shell_log import (
	ExecuteResult,
...
class Bench(Document):
	...
	if TYPE_CHECKING:
		...
		from cloud.cloud.doctype.bench_app.bench_app import BenchApp
		from cloud.cloud.doctype.bench_mount.bench_mount import BenchMount
		from cloud.cloud.doctype.bench_variable.bench_variable import BenchVariable
