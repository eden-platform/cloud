...
from cloud.cloud.doctype.site_update.test_site_update import create_test_site_update

from cloud.cloud.doctype.version_upgrade.version_upgrade import VersionUpgrade
