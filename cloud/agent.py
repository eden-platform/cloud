...
from cloud.utils import log_error, sanitize_config

if TYPE_CHECKING:
	from io import BufferedReader

	from cloud.cloud.doctype.app_patch.app_patch import AgentPatchConfig, AppPatch
...
class Agent:
	...
	def backup_site(self, site, with_files=False, offsite=False):
		from cloud.cloud.doctype.site_backup.site_backup import get_backup_bucket
