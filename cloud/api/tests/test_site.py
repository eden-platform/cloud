...
from cloud.api.site import all
from cloud.cloud.doctype.agent_job.agent_job import AgentJob, poll_pending_jobs
from cloud.cloud.doctype.agent_job.test_agent_job import fake_agent_job
from cloud.cloud.doctype.app.test_app import create_test_app
...
from cloud.cloud.doctype.deploy_candidate_difference.test_deploy_candidate_difference import (
	create_test_deploy_candidate_differences,
)
from cloud.cloud.doctype.site_plan.test_site_plan import create_test_plan
from cloud.cloud.doctype.release_group.test_release_group import (
	create_test_release_group,
)
from cloud.cloud.doctype.remote_file.remote_file import RemoteFile
...
class TestAPISite(FrappeTestCase):
	...
	def test_options_contains_only_public_groups_when_private_group_is_not_given(
		...
		from cloud.api.site import get_new_site_options
	...
	def test_new_fn_creates_site_and_subscription(self):
		from cloud.api.site import new
	...
	def test_get_fn_returns_site_details(self):
		from cloud.api.site import get
	...
	def test_check_for_updates_shows_update_available_when_site_update_available(self):
		from cloud.api.site import check_for_updates
	...
	def test_installed_apps_returns_installed_apps_of_site(self):
		from cloud.api.site import installed_apps
	...
	def test_available_apps_shows_apps_installed_in_bench_but_not_in_site(self):
		from cloud.api.site import available_apps
	...
	def test_install_app_adds_to_app_list_only_on_successful_job(self):
		from cloud.api.site import install_app
	...
	def test_uninstall_app_removes_from_list_only_on_success(self):
		from cloud.api.site import uninstall_app
	...
	def test_restore_job_updates_apps_table_with_output_from_job(self):
		from cloud.api.site import restore
...
"""
	...
	def test_site_change_group(self):
		from cloud.api.site import change_group, change_group_options
		from cloud.cloud.doctype.site_update.site_update import process_update_site_job_update
	...
	def test_site_version_upgrade(self):
		from cloud.api.site import version_upgrade, get_private_groups_for_upgrade
		from cloud.cloud.doctype.site_update.site_update import process_update_site_job_update
