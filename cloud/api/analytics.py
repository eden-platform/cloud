...
from cloud.cloud.report.binary_log_browser.binary_log_browser import (
...
def mariadb_slow_queries(site, start, end, pattern=".*", max_lines=100):
	from cloud.cloud.report.mariadb_slow_queries.mariadb_slow_queries import (
		get_slow_query_logs,
	)
	from cloud.utils import convert_user_timezone_to_utc
...
def deadlock_report(site, start, end, max_lines=20):
	from cloud.cloud.report.mariadb_deadlock_browser.mariadb_deadlock_browser import (
		post_process,
	)
