...
from cloud.api.account import get_account_request_from_key, setup_account
from cloud.api.saas import (
	check_subdomain_availability,
	create_marketplace_subscription,
	create_or_rename_saas_site,
)
from cloud.cloud.doctype.site.saas_site import get_saas_domain
...
def callback(code=None, state=None):
	...
	if (state == cached_state) or (saas_app):
		...
		return "Invalid state parameter. The session timed out. Please try again or contact  Eden Cloud support at https://frappecloud.com/support"
