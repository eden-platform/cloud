...
export default {
	...
	resources: {
		getSiteAutoUpdateInfo() {
			return {
				url: 'cloud.api.site.get_auto_update_info',
				params: {
					name: this.site?.name
				},
				auto: true,
		...
		enableAutoUpdate() {
			return {
				url: 'cloud.api.site.enable_auto_update',
				params: {
					name: this.site?.name
				},
				onSuccess() {
		...
		disableAutoUpdate() {
			return {
				url: 'cloud.api.site.disable_auto_update',
				params: {
					name: this.site?.name
				},
				onSuccess() {
		...
		updateAutoUpdateInfo() {
			return {
				url: 'cloud.api.site.update_auto_update_info',
				params: {
					name: this.site?.name,
					info: {
